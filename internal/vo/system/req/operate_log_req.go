...
type AddOperateLogReqVo struct {
	...
	OperateParam    string    `json:"operateParam" binding:"required"`    // 请求参数
	JsonResult      string    `json:"jsonResult" binding:"required"`      // 返回参数
	...
	OperateTime     time.Time `json:"operateTime" binding:"required"`     // 操作时间
	CostTime        int64     `json:"costTime" binding:"required"`        // 消耗时间
}
