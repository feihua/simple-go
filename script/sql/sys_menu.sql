...
INSERT INTO sys_menu (id, menu_name, menu_type, status_id, sort, parent_id, menu_url, api_url, menu_icon, remark, create_time, update_time) VALUES (4, '角色管理', 2, 1, 2, 2, '/role', '/api/role/queryRoleList', '', '角色管理', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO sys_menu (id, menu_name, menu_type, status_id, sort, parent_id, menu_url, api_url, menu_icon, remark, create_time, update_time) VALUES (5, '菜单管理', 2, 1, 3, 2, '/menu', '/api/menu/queryMenuList', 'setting', '菜单管理', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
